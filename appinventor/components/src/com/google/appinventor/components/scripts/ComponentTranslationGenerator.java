...
public final class ComponentTranslationGenerator extends ComponentProcessor {
  ...
  private static final String AUTOGEN_OUTPUT_FILE_NAME = "OdeMessagesComponent.java";
  private static final String AUTOGEN_PROPERTY_FILE_NAME = "OdeMessagesProperty.java";
  private static final String AUTOGEN_FUNCTION_FILE_NAME = "OdeMessagesFunction.java";
  ...
  protected void outputAutogenOdeMessages() throws IOException {
    ...
    StringBuilder sb_designer = new StringBuilder();
    StringBuilder sb_properties = new StringBuilder();
    StringBuilder sb_functional = new StringBuilder();
    sb_designer.append("// THIS FILE IS AUTOMATICALLY GENERATED DURING COMPILATION.\n");
    sb_designer.append("// DO NOT EDIT THIS FILE. ANY CHANGES WILL BE OVERWRITTEN.\n\n");
    sb_designer.append("package com.google.appinventor.client;\n\n");
    sb_designer.append("import com.google.gwt.i18n.client.Messages;\n\n");
    sb_properties.append(sb_designer);
    sb_functional.append(sb_designer);

    sb_designer.append("public interface OdeMessagesComponent extends Messages {\n");
    sb_properties.append("public interface OdeMessagesProperty extends Messages {\n");
    sb_functional.append("public interface OdeMessagesFunction extends Messages {\n");
    sb_designer.append("\n  /* Components */\n");
    for (Map.Entry<String, ComponentInfo> entry : components.entrySet()) {
      ComponentInfo component = entry.getValue();
      outputComponentAutogen(component, properties, methods, events, parameters, sb_designer);
    ...
    sb_functional.append("\n  /* Methods */\n");
    for (Map.Entry<String, Method> entry : methods.entrySet()) {
      outputMethodAutogen(entry.getValue(), sb_functional);
    }
    sb_functional.append("\n  /* Events */\n");
    for (Map.Entry<String, Event> entry : events.entrySet()) {
      outputEventAutogen(entry.getValue(), sb_functional);
    }
    ...
    for (Map.Entry<String, Parameter> entry : parameters.entrySet()) {
      outputParameterAutogen(entry.getValue(), sb_functional);
    }
    sb_designer.append("\n  /* Component Categories */\n");
    for (String category : categories) {
      outputCategoryAutogen(category, sb_designer);
    }
    sb_properties.append("\n  /* Property Categories */\n");
    ...
    writer.write(sb_designer.toString());
    writer.flush();
    writer.close();
    ...
    FileObject src3 = createOutputFileObject(AUTOGEN_FUNCTION_FILE_NAME);
    Writer writer3 = src3.openWriter();
    writer3.write(sb_functional.toString());
    writer3.flush();
    writer3.close();

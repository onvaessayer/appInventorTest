...
public final class ComponentTranslationGenerator extends ComponentProcessor {
  ...
  private static final String AUTOGEN_FUNCTION_FILE_NAME = "ComponentFunctionTranslations.java";
  ...
  protected void outputAutogenOdeMessages() throws IOException {
    ...
    sb_designer.append("package com.google.appinventor.client.editor.simple.components.i18n;\n\n");
    ...
    sb_designer.append("public interface ComponentInfoTranslations extends Messages {\n");
    sb_properties.append("public interface ComponentPropertyTranslations extends Messages {\n");
    sb_functional.append("public interface ComponentFunctionTranslations extends Messages {\n");
    sb_designer.append("\n  /* Components */\n");
